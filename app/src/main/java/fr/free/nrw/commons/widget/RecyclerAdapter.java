 ...
 * @param <VH> ViewHolder {@link RecyclerViewHolder}
 */
public abstract class RecyclerAdapter<T, L extends BaseRecyclerListener, VH extends RecyclerViewHolder<T, L>> extends RecyclerView.Adapter<VH> {
